    ...
    return (
        <GuestLayout>
            ...
            <div className="mb-4 text-lg text-gray-600">
                ...
                que te acabamos de enviar? Si no recibiste el correo
            ...
            <form onSubmit={submit}>
                <div className="mt-4 flex items-center justify-between">
                    ...
                    <Link
                        ...
                        method="post"
                        as="button"
                        className="rounded-md text-lg text-gray-600 underline hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                    >
                        Cerrar Sesión
                    </Link>
                </div>
